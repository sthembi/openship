...
function _placeZincOrder() {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee13(data, token) {
    var settings, response, res, eRes;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            _context13.prev = 1;
            _context13.next = 4;
            return fetch("http://localhost:3000/api/zinc/purchase?token=".concat(token), settings // {
            //   method: 'POST',
            //   headers: {
            //     'Content-Type': 'application/json',
            //   },
...
//# sourceMappingURL=index.js.94b71c96b10ae8c30b8d.hot-update.js.map