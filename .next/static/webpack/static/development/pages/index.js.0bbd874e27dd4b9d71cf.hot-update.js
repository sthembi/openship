      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            console.log('ify', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()({
              friend: 'frank'
            }));
            settings = {
              method: 'POST',
              body: "{ friend: 'frank' }" // headers: {
              //   'Content-Type': 'application/json',
              // },
...
//# sourceMappingURL=index.js.0bbd874e27dd4b9d71cf.hot-update.js.map