...
/******/ 	return __webpack_require__(__webpack_require__.s = "y/VD");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  try {
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_0___default()(`https://api.zinc.io/v1/search?query=${req.query.query}&page=1&retailer=amazon`, {
      headers: {
        Authorization: `Basic ${Buffer.from(`${req.query.token}:`).toString('base64')}`
      }
    }).then(response => {
...
try {
  ...
  module.exports = __webpack_require__("Z2QC");
}
...
var inherits = __webpack_require__("DzEC")
...
var createError = __webpack_require__("M41f")
...
const raw_body_1 = __importDefault(__webpack_require__("PaCr"));
...
function getCookieParser(req) {
    return function parseCookie() {
        ...
        const { parse } = __webpack_require__("tXQS");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var next_server_dist_server_api_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("iDuJ");
/* harmony import */ var next_server_dist_server_api_utils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_server_dist_server_api_utils__WEBPACK_IMPORTED_MODULE_0__);
      ...
      /* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
        ...
        Object(next_server_dist_server_api_utils__WEBPACK_IMPORTED_MODULE_0__["apiResolver"])(req, res, params, resolver)
      });
