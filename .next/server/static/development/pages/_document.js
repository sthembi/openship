...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_2___default.a {
  static getInitialProps({
    ...
    // );
    const page = renderPage(); // const styleTags = sheet.getStyleElement();

    const {
      css,
      hydrationScript
    } = Object(evergreen_ui__WEBPACK_IMPORTED_MODULE_3__["extractStyles"])();
  ...
  render() {
    ...
    }), this.props.hydrationScript), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("body", {
      style: {
        margin: 0
      }
