...
class Page extends Component {
  ...
  render() {
    const { children, shopsURL } = this.props;
                ...
                <>
                  ...
                  <Pane className="show">
                    ...
                    >
                      ...
                      >
                        <Pane className="hover" borderRadius={7}>
                          <svg
                            width={38}
                            height={38}
                            viewBox="0 0 24 24"
                      ...
                      <Pane width="200px" marginRight={7}>
                        <Logo />
                      </Pane>
                    </Pane>
                  </Pane>
                  ...
                  >
                    {shops.length || shopsURL ? (
                      // <Pane background="rgb(245, 246, 247)">
                      <Pane maxWidth="1100px" marginY="0px" marginX="auto">
                        {children}
                      </Pane>
                    ) : (
                      // </Pane>
                      ...
                      >
                        <Pane
                          ...
                          paddingTop={150}
                        >
                          <Heading size={800} paddingBottom={15}>
                            Take full control of your e-commerce operations
                          </Heading>
                          <Text size={500} fontSize="18px">
                          ...
                          <form method="GET" action="/shopify/auth">
                            ...
                            >
                              ...
                              <TextInput
                                // boxShadow="inset 0 0 0 1px rgb(54, 164, 110) !important"
                                // boxShadow="0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06) !important"
